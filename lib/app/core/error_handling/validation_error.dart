...
abstract class ValidationError extends DomainError {
  ...
  factory ValidationError.noError({String message = ''}) =>
      _NoError(message: message);
  factory ValidationError.requiredField({String message = ''}) =>
      _RequiredField(message: message);
  factory ValidationError.invalidField({String message = ''}) =>
      _InvalidField(message: message);
  factory ValidationError.fieldsDoNotMatch({String message = ''}) =>
      _FieldsDoNotMatch(message: message);
  factory ValidationError.minimumLength({String message = ''}) =>
      _MinimumLength(message: message);
}
