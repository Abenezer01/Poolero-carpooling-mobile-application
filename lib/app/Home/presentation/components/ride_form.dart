...
class RideForm extends GetWidget<MapController> {
                ...
                child: Column(
                  children: [
                    ...
                    InputIcon(
                      ...
                      validator: (value) =>
                          controller.textFieldValidation(value, 'origin'),
                    ),
                    Row(
                    ...
                    InputIcon(
                      ...
                      validator: (value) =>
                          controller.textFieldValidation(value, 'destination'),
                    ),
                    SizedBox(height: 5),
                    Row(
                      children: [
                        Expanded(
                          child: InputIcon(
                            ...
                            validator: (value) =>
                                controller.pickTimeValidation(value),
                          ),
                        ),
                        Expanded(
                          child: Container(
                            ...
                            children: [
                              Expanded(
                                child: InputIcon(
                                  ...
                                  validator: (value) => controller
                                      .textFieldValidation(value, 'total cost'),
                                ),
                              ),
                              Expanded(
                                child: Container(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Checkbox(
                                        ...
                                        onChanged: (value) {
                                          controller.allowSmocking.value =
                                              value!;
                                        },
                                        activeColor: AppTheme.primaryColor,
                                      ),
                                ...
                                child: Container(
                                  child: InputIcon(
                                    ...
                                    textController: controller
                                        .requestedSeatsController.value,
                                  ),
                                ),
                              ),
                            ],
  ...
  void choosingCar(BuildContext context) {
    GlobalKey<NavigatorState>? carsDialog = GlobalKey<NavigatorState>();
    Get.defaultDialog(
      navigatorKey: carsDialog,
      title: 'Select your vehicule',
      titlePadding: EdgeInsets.symmetric(vertical: 10),
      content: Container(
        width: context.mediaQuery.size.width * .99,
        child: Obx(
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                controller.choosedCarController.value.text =
                                    '${controller.carsList[index].model.name} - ${controller.carsList[index].mark.name}';
                                controller.choosedCar.value =
                                    controller.carsList[index].id;
                                print(controller.carsList[index].id);
                                Get.close(1);
                              },
                              child: Container(
                                height: 56,
                                child: Image.asset('assets/Body Type.png'),
                              ),
                            ),
                            Text(
                            ...
                            SizedBox(height: 5),
                            Text(
                              controller.carsList[index].model.name,
                              style: TextStyle(
