                      ...
                      child: Column(
                        children: [
                            ...
                            children: [
                              Expanded(
                                child: MyTextField(
                                  ...
                                  labelText: 'License plate (1234-A-56)',
                                  validator: (value) =>
                                      controller.licensePlateValidation(value),
                                ),
                              ),
                            ],
                          ),
                          ...
                          Obx(
                            () => DropdownButtonFormField(
                              validator: (value) => controller
                                  .carPropertyValidation(value, 'mark'),
                              hint: Text(
                                'choose one mark',
                              ),
                              isExpanded: true,
                              ...
                              onChanged: (value) {
                                controller.car.update((val) {
                                  ...
                                  // controller.marksModels.refresh();
                                });
                                controller
                                    .loadModels(controller.car.value.mark.id);
                              },
                          ...
                          Obx(
                            () => DropdownButtonFormField(
                              validator: (value) => controller
                                  .carPropertyValidation(value, 'color'),
                              hint: Text(
                                'choose one color',
                              ),
                              isExpanded: true,
                              ...
                              Expanded(
                                child: Container(
                                  child: Obx(
                                    () => DropdownButtonFormField(
                                      validator: (value) =>
                                          controller.carPropertyValidation(
                                              value, 'model'),
                                      value: controller
                                              .car.value.model.id.isNotEmpty
                                      ...
                                      isExpanded: true,
                                      items: controller.marksModels.isNotEmpty
                                          ? controller.marksModels
                                              .map((vl) => DropdownMenuItem(
                                                  value: vl.id,
                                                  child: Text(vl.name)))
                                              .toList()
                            ...
                            children: [
                              Expanded(
                                child: MyTextField(
                                  ...
                                  validator: (value) =>
                                      controller.modelYearValidation(value),
                                ),
                              ),
                            ],
                          ),
                                  ...
                                  child: MyButton(
                                    onPresse: () {
                                      !Get.arguments['addCar']
                                          ? controller.submitForm('update')
                                          : controller.submitForm('add');
                                    },
                                    isPrimary: true,
                                    isDisabled: false,
                                    textTitle: !Get.arguments['addCar']
                                        ? 'Update Car'
                                        : 'Add Car',
                                  ),
                                ),
